...
drop table if exists  sem_5.db_instructor_salary;

CREATE TABLE sem_5.db_instructor_salary (
    name VARCHAR (120),
    dt DATE,
...
INSERT INTO sem_5.db_instructor_salary VALUES ('Смолкина Юлия', '2019-02-25', 2999.00, 1);
INSERT INTO sem_5.db_instructor_salary VALUES ('Викентьев Михаил', '2019-03-05', 5100.00, 1);
INSERT INTO sem_5.db_instructor_salary VALUES ('Викентьев Михаил', '2019-03-05', 6800.00, 3);
INSERT INTO sem_5.db_instructor_salary VALUES ('Лушко Есения', '2019-02-25', 10499.00, 1);
INSERT INTO sem_5.db_instructor_salary VALUES ('Лушко Есения', '2019-03-05', 13000.00, 1);
INSERT INTO sem_5.db_instructor_salary VALUES ('Шевченко Игорь', '2024-02-25', 2999.00, 2);
INSERT INTO sem_5.db_instructor_salary VALUES ('Шевченко Игорь', '2024-02-25', 5800.00, 2);
INSERT INTO sem_5.db_instructor_salary VALUES ('Шевченко Игорь', '2024-03-05', 6400.00, 1);
INSERT INTO sem_5.db_instructor_salary VALUES ('Шевченко Игорь', '2024-03-05', 8300.00, 2);

SELECT *
FROM sem_5.db_instructor_salary;
...
-- SELECT name
--     FROM sem_5.db_instructor_salary AS t2
--     WHERE salary_type = 2

SELECT name, salary_type, sum(salary_amt)
FROM sem_5.db_instructor_salary AS t1
WHERE EXISTS (
    SELECT name
    FROM sem_5.db_instructor_salary AS t2
...
FROM sem_5.db_instructor_salary as t1 JOIN
    (
    SELECT name, dt, count(*) AS count_salary
    FROM sem_5.db_instructor_salary
    GROUP BY name, dt
